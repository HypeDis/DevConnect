...
router.post(
  ...
  (req, res) => {
    ...
    if (req.body.website) profileFields.websit = req.body.website;
...
router.post(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then(profile => {
      ...
      // add to exp array
      profile.experience.unshift(newExp); //put it in the front of the experience array
...
router.post(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then(profile => {
      ...
      // add to exp array
      profile.education.unshift(newEdu); //put it in the front of the experience array
      profile.save().then(profile => res.json(profile));
    });
  }
);
